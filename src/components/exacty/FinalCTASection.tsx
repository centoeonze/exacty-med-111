  ...
  return (
    <section className="exacty-section-blend relative overflow-hidden bg-transparent py-16 md:py-20 lg:py-24">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute left-1/2 top-1/2 h-[360px] w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-violet-500/10 blur-[124px] md:h-[440px] md:w-[440px]" />
        <div className="absolute left-[14%] top-[18%] h-[160px] w-[160px] rounded-full bg-fuchsia-500/6 blur-[88px]" />
        <div className="absolute right-[12%] bottom-[16%] h-[180px] w-[180px] rounded-full bg-violet-400/8 blur-[96px]" />
        <div className="absolute left-1/2 top-0 h-24 w-[min(860px,86vw)] -translate-x-1/2 bg-[radial-gradient(ellipse_at_center,rgba(118,74,224,0.08),rgba(118,74,224,0.02)_46%,transparent_74%)] blur-[40px]" />
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-6 md:px-8">
        <motion.div
          ...
          className="relative mx-auto max-w-[720px] overflow-hidden rounded-[28px] border border-white/10 bg-white/[0.04] px-5 py-6 text-center backdrop-blur-lg shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_24px_80px_rgba(90,48,210,0.18)] sm:px-6 md:max-w-[820px] md:rounded-[32px] md:px-7 md:py-7 lg:max-w-[900px] lg:px-8 lg:py-8"
        >
